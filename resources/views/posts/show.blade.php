    ...
    <div class="container mx-auto md:flex" >
            ...
            <div class="md:w-1/2">
                <div class="shadow bg-white p-5 mb-5">
                    ...
                    <p class="text-xl font-bold text-center mb-4"> Argega un nuevo comentario </p>
                    ...
                    @endif
                     ...
                     <form action="{{route('comentarios.store', ['user'=> $user, 'post'=>$post])}}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <input id="comentario" name="comentario" type="text" placeholder="Comentar" class="border p-3 w-full rounded-lg"/>
